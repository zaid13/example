                ...
                Obx(
                  () => controller.isFileLoading.value
                      ...
                      : controller.isFileDataLoading.value ||
                              controller.isFileDownLoadingNow.value
                          ? Expanded(
                              child: Container(
                                height: MediaQuery.of(context).size.height,
                                width: MediaQuery.of(context).size.width,
                          ...
                          : Expanded(
                              child: Padding(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemCount:
                                      directoryNode.subdirectories!.length +
                                  ...
                                  itemBuilder: (context, index) {
                                    if (index <
                                      ...
                                      return GestureDetector(
                                        onTap: () {
                                          controller.isFileDownLoadingNow
                                              .value = true;
                                          controller.selectedFileIndex =
                                              controller.fileList.indexWhere(
                                                  (element) =>
